...
const Navbar = () => {
    ...
    const logoutHandler = async () => {
        try {
            const res = await axios.get('https://zenmail.onrender.com/api/v1/user/logout',{withCredentials:true});
            console.log(res);
        ...
        <div className='flex items-center justify-between mx-3 h-16'>
            <div className='flex items-center gap-10'>
                <div className='flex items-center gap-2'>
                    ...
                    <img className='w-8' src="https://cdn-icons-png.freepik.com/512/6557/6557838.png" alt="logo" />
